...
import { createNewEmployee } from "../../features/employee/employeeApiSlice";
import {
  fetchAllEmployee,
  setMessageEmpty,
...
const CreateEmployee = () => {
  ...
  const { loader, message, error } = useSelector(fetchAllEmployee);
  ...
  const handleFormSubmit = (e) => {
    ...
    if (documents) {
      documents.forEach((item) => {
        form_data.append("userDocuments", item);
      });
    }

    dispatch(createNewEmployee(form_data));
  };
